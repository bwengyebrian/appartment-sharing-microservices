...
public class BookingController {
	...
	public String add(@RequestBody Bookings booking, HttpServletRequest request) {
		...
		PaymentDTO paymentDTO=new PaymentDTO(booking.getUser_id(),total);
...
//		ResponseEntity<String> paymentResponse = restTemplate.exchange("http://localhost:8081/makePayment/paypal", HttpMethod.POST,
